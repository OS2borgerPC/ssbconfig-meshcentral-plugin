      ...
      if (typeof window.ssbconfigRenderDeviceTab !== "function") {
        window.ssbconfigRenderDeviceTab = function () {
          ...
          moveBtn.addEventListener("click", function () {
            ...
            if (typeof meshserver !== "object" || meshserver == null || typeof meshserver.send !== "function") {
              statusEl.textContent = "MeshCentral connection is unavailable.";
              return;
            }
            ...
            try {
              meshserver.send({ action: "changeDeviceMesh", nodeids: [latestNode._id], meshid: targetMeshId });
              statusEl.textContent = "Move request sent.";
